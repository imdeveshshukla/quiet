...
import { getUserPosts, getUsers, getUserComments, getUserUpvotes,  getLCdata, getUserPolls } from '../controller/search.js'
...
searchRouter.get("/getuserpolls/", getUserPolls);
