        ...
        <div ref={searchRef} className="search flex items-center relative ">
            ...
            <div className='relative'>
                ...
                {menu && <div className=' absolute top-0 min-h-20 bg-[#c2c7b3] w-full rounded-3xl -z-10 '>
                    ...
                    <div className=' text-md font-semibold py-1 px-4'>People</div>
                    <div className='py-2 px-4 flex flex-col'>
                        {users.map(user => {
                            return <>
                                <div onClick={()=>openUserProfile(user.userID)} className=' flex items-center gap-4 cursor-pointer hover:bg-[#b9c19e] rounded-lg py-2 px-4'>
                                    <img
