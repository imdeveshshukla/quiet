          ...
          firstPage ?
            ...
            <>
              ...
              <div className="flex justify-end">
                ...
                <button
                  onClick={next}
                  className={titleRequired ? "bg-[#656923] w-32 xxs:w-36 sm:w-48 text-sm text-black font-bold py-2 px-4 rounded focus:outline-none cursor-not-allowed" : "bg-[#656923] hover:bg-[#a9aa88] w-48 text-sm text-black font-bold py-2 px-4 rounded focus:outline-none"}>
                  {"Save & Next"}
                </button>
