            ...
            <>
              ...
              <div className="mb-4 relative">
                <div className="mb-5 flex flex-col">
                  ...
                  >Room name <span className=" text-red-600">*</span></label>
                  <div className=" text-xs font-mono">{titleLen}/{titleLimit}</div>
                  </div>
                  <input  spellCheck="false" type="text"
                    className={`bg-${color}-50 border border-${color}-500 text-${color}-900 outline-none placeholder-${color}-700 text-sm rounded-lg focus:ring-${color}-500 focus:border-${color}-500 block w-full p-2.5 `}
                    placeholder="IET_Club"
                    value={title}
                    onChange={(e) => {
                      handleTitleChange(e)
                    }} />
                  <p className={`mt-2 text-sm text-${color}-600`}>
                    ...
                    <span className={`${titleRequired&& 'text-red-500'} text-xs`}>{error}</span>
                  </p>
                </div>
