...
const CreatePost = () => {
  ...
  return (<div className=" relative h-[90%]  overflow-auto">
    ...
    <div className="heading flex justify-between ">
      <h2 className="text-xl font-bold mb-2 text-[#656923]">Write your thoughts....</h2>
    ...
    {!roomTitle ? <div className='flex mt-2 px-28 justify-start  '>
      ...
      <div>
        ...
        <button disabled={loading}
          type="submit"
          className={` ${loading && ' cursor-wait bg-[#4e5024]'} bg-[#656923] flex justify-center mt-2 hover:bg-[#a9aa88] w-full text-xl text-black font-bold py-2 px-4 rounded focus:outline-none`}
        >
